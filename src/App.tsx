...
export default function App() {
	...
	return (
		<div className="grid gap-7 p-6">
			...
			<div>
				<InputSingleFile form={form} allowedExtensions={['png', 'jpg', 'jpeg', 'webp']} maxFileSizeInMB={50} replaceBy={<ImageFilePreview src={fileSource} alt="Imagem" />} {...form.register("file")} />
			</div>
		</div>
	);
}
